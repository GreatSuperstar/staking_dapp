                  ...
                  <div className="row">
                    ...
                    >
                      <div className="blockcain-content">
                        ...
                        <h3 className="column-title" style={{textAlign:'center'}}>The COFF Token</h3>
                        <p className="ps_titleTitle">
                              The COFF token is a Binance smart chain (BSC) deflationary token. <br/><br/>
                            ...
                            The COFF tokens deflationary nature means that each time a transaction occurs using a deflationary token a percentage of the tokens used in the transactions are destroyed permanently. <br/><br/>
                  ...
                  <div className="work-token-item">
                    <ul>
                      <li>
                        ...
                        <span> 3,000,000,000,000 COFF - 100% </span>
                      </li>
                      <li>
                        <strong>Private-Sale price</strong>
                        <span> 400,000,000 COFF per BNB </span>
                      </li>
                      <li>
                        <strong>Pre-Sale price</strong>
                        <span> 360,000,000 COFF per BNB </span>
                      </li>
                      <li>
                        <strong>Listing Rate</strong>
                        <span> 324,000,000 COFF per BNB </span>
                      </li>
                      <li>
