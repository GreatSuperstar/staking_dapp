                ...
                <div className="row">
                  <div className="col-lg-8 mx-auto">
                    <div className="banner-content">
                      <h1 className="banner-title">Welcome to the Vesting Ecosystem</h1>
                      <p>
                        COFFATO is a decentralized BSC project that will use the COFF token to reward
                  ...
                  <div className="row">
                    ...
                    >
                      <div className="blockcain-content">
                        ...
                        <h3 className="column-title">The COFF Token</h3>
                        <p>
                          The COFF token is a Binance smart chain (BSC) deflationary token.
                          ...
                          called BEP-20. The COFF tokens deflationary nature means that each time
                    ...
                    <form onSubmit={onSubmit}>
                      <div>
                        ...
                        <input 
                          ...
                          onChange={handleChange}
                        /><br/>
                        <div  className='preSaleTitle'>Please note:<br/> Your COFF tokens will be airdropped to your wallet address after our Whitelisted Pre-sale ends</div>
                      </div>
                  ...
                  <div className="work-token-item">
                    <ul>
                      ...
                      <li>
                        ...
                        <span>1BNB = 320,000,000 COFF</span>
                      </li>
                      <li>
              ...
              <div className="container-fluid">
                <div className="row">
                  <div className="col-lg-8 mx-auto">
                    <div className="section-title-item">
                      <small className="xs-section-title"></small>
                      <h2 className="section-title">COFFATO Roadmap</h2>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="row roadmap-timeline-item">
                      ...
                      <div className="col-md xs-roadmap wow fadeInUp" data-wow-duration="2.5s">
                        <div className="single-roadmap-timeline">
                          ...
                          <h3>Dec 2021</h3>
                          <p> 
                            Pre-Sale COFF Token<br/> 
                            Public Launch COFF<br/>
                            List on CMC & CG<br/>
                            (fast-tracked)<br/>
                            Trend on DEX & CMC<br/> 
