                        ...
                        <div className="row">
                          <div className="col-md-6 align-self-center">
                            <div className="xs-tabs-content">
                              <h3 className="xs-single-title underline">The COFFATO App</h3>
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="xs-white-tabs-content">
                              ...
                              <p> Please download our whitepaper below COFFATO is a multi module application that will generate revenue and rewards for its community. Our aim is to change how we interact with our digital assets. </p>
