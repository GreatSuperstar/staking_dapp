          ...
          <div className="container">
            ...
            <div className="row vesting-section1">
              <div className=" col-lg-4 offset-lg-1 col-md-6 align-self-center" >
                <h2 className="section-title wow fadeInUp"  data-wow-duration="2.5s"><i>COFF Vest Rewards</i></h2>
                <img className="wow fadeInUp"   data-wow-duration="2s" src="assets/images/blockchain/COFFATOcoin.png"/>
              ...
              <div className="content col-lg-5 offset-lg-1 col-md-6 align-self-center wow fadeInUp" data-wow-duration="2s">
                <div className='content-title'><i>COFFATO vesting program</i></div>
                <div className='content-body'><i>Earn rewards by simply holding our COFF token in our specified wallets by selecting an options which best suits</i></div>
                ...
                <div className='content-footer'><i>www.COFFATO.io</i></div> 
              </div>
            </div>
